...
public class LearnArrays {
	...
	System.out.println("HIII"+mentors[0]);
	System.out.println("HIII"+mentors[1]);
	System.out.println("HIII"+mentors[2]);
	System.out.println("HIII"+mentors[3]);
	System.out.println("HIII"+mentors[4]);
	System.out.println("HIII"+mentors[5]);
