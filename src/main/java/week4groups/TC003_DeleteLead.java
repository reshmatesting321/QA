...
//test NG groups example
public class TC003_DeleteLead extends ProjectWrapper {

	//@Test(groups={"sanity"}, dataProvider="fetchDataDel") //iii) Run all 5 TestCases in parallel
	@Test(groups={"sanity"}, dependsOnGroups={"smoke"}, dataProvider="fetchDataDel")
